...
class LinkedBinaryTree(BinaryTree):
    ...
    def _add_root(self, e):
        """Place eleemnt e at the root of an empty tree and return new Position
        
        Raise ValueError if root is empty
        """
    ...
    def _add_left(self, p, e):
        """Create a new left child for Position p storing elemet e
