"""
This is a solution of #3.3 from Cracking The Coding Interview
...
# -------------------------- nested nonpublic class-----------------------------------
    class _Node:
        """Lightweight utility to hold a value"""
    ...
    def remove_bottom(self):
        b = self._bottom
        self._bottom = self._bottom.above
        if self._bottom:
            self._bottom.below = None
...
class SetOfStacks:
    ...
    def pop_at(self, index):
        return self._left_shift(index, True)

    def _left_shift(self, index, remove_top):
        ...
        if stack.is_empty():
            ...
            v = self._left_shift(index + 1, False)
            stack.push(v)
